            ...
            <div className='max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow shadow-slate-300'>
                <form onSubmit={registerUser} className='my-10'>
                    <div className="flex flex-col">
                        ...
                        <button type='submit' className='w-full py-3 font-bold text-white bg-indigo-600 hover:bg-indigo-500 rounded-lg border-indigo-500 hover:shadow'>Daftar</button>
                    </div>
                </form>
            </div>
        </div>

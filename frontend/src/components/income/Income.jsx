...
const Income = () => {
  ...
  const handleShowInvoice = (e) => {
    ...
    if (selectedCategory) {
      const basePrice =
        selectedCategory.harga_barang * parseInt(jumlahPembelian);
              ...
              <table className="min-w-full bg-gray-400">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-2 text-xl font-bold">
                      {showInvoice ? jumlahPembelian + " Pcs" : "-"}
                    </td>
                  </tr>
                </tbody>
              </table>
                ...
                <tbody>
                      ...
                      {showInvoice
                        ? "Rp. " +
                          formatRupiah(
                            categories.find(
                              (c) => c.id === parseInt(categoryId)
                            )?.harga_barang * parseInt(jumlahPembelian)
                          )
                        : "-"}
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-2 text-2xl font-bold">
                      {showInvoice ? "Rp. " + formatRupiah(totalPrice) : "-"}
                    </td>
                  </tr>
                </tbody>
              </table>
